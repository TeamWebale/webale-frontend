...
function GroupDetails() {
  ...
  const handleInvite = async () => {
    ...
    const defaultMessage = `*${userName}* cordially invites you to join *${groupName}* a private fundraising group on *Webale!* You would have to sign-in to 'accept' this invite in order to join the fundraising group; so follow the link below to sign-in or to first sign-up so you may sign-in. See you there! 🤝

*#Webale* is offering in to automate hitherto manually driven fundraising operations and records. Privacy First: Each group is invitation-only so participation is exclusive to trusted people (family, friends, colleagues, communities).
