    ...
    <div>
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 14px', fontStyle: 'italic', opacity: 0.85 }}>
          It was frustrating watching fundraisers manually repost to update donor groups of the campaign progress; so we built <strong>Webale!</strong> to automate a number of things.
        </p>
        <p style={{ margin: '0 0 14px' }}>
          Invitation-only groups already trust each other so they simply need a structured, transparent way to pool money. <strong>Webale!</strong> is designed with your fundraising circle in mind; so across the board your donors get clarity of the fundraising target, progress and many things in between.
        </p>
        <p style={{ margin: '0 0 14px' }}>
          Get all pledges tracked and contributions logged so members are kept updated of who committed what, who fulfilled, even who quit; and the rest of the money conversation. Real-time progress bars charm members with a visual of how far from and/ or how close we are to the finishing line.
        </p>
        <p style={{ margin: '0 0 14px' }}>
          The rest is quarterly milestone marks, multi-currency conversion across 160+ countries, automated reminders and acknowledgements, built-in member messaging, admin controls that put fundraisers firmly in charge, etc. That much for just a sneak peek into innovation we intend to deploy for the success of your fundraising cause.
        </p>
        <p style={{ margin: '0 0 14px' }}>
          Be it a five member family group or five hundred diaspora contributors, <strong>Webale!</strong> replaces the chaos of manual record-keeping with a living and breathing dashboard that keeps everyone aligned, motivated, acknowledged and notified.
        </p>
