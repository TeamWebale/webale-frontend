  ...
  return (
    <aside style={ls.wrap}>
      ...
      <NavLink to="/terms" style={({ isActive }) => ({
        ...
        background: isActive ? "linear-gradient(135deg,#1B2D4F,#4A7FC1)" : "linear-gradient(135deg,#e6fffa,#b2f5ea)",
        color: isActive ? "#fff" : "#234e52",
        transition:"all 0.15s",
      })}>
...
const ml = {
  shell:{ minHeight:"100vh", backgroundColor:"#f0f4f9", backgroundImage:"radial-gradient(#1B2D4F 0.8px, transparent 0.8px)", backgroundSize:"20px 20px", display:"flex", flexDirection:"column", fontSize:"16px" },
